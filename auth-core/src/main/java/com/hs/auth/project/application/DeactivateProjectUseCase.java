...
public class DeactivateProjectUseCase {
    ...
    public DeactivateProjectUseCase(ProjectRepository projectRepository) {
    ...
    public Project execute(ActivateProjectCommand command) {
        ...
        Project deactivatedProject = project.deactivate();
        return projectRepository.save(deactivatedProject);
    }
}